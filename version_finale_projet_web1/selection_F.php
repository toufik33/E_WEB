...
$sql = mysql_query("SELECT count(DISTINCT product_name) FROM products  WHERE category=	'Femme' ");
...
$sql ='SELECT * FROM products WHERE category = "Femme" GROUP BY product_name ASC limit '.$limite.','.$nombre;
...
?>
    ...
    <center><h2><em><u><font color = 'red' >Femme</font></h2>
	<p> Tailles : du 36 au 42 </p>
