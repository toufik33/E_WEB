...
$sql = mysql_query("SELECT count(DISTINCT product_name) FROM products  WHERE subcategory =	'reebok'  ");
...
$sql ='SELECT * FROM products WHERE subcategory = "reebok" GROUP BY product_name ASC limit '.$limite.','.$nombre;
...
?>
    ...
    <center><h2><em><u><font color = 'red' >Catégorie Reebok  </font></h2>
