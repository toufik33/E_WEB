...
$sql = mysql_query("SELECT count(DISTINCT product_name) FROM products  WHERE subcategory =	'coq'  ");
...
$sql ='SELECT * FROM products WHERE subcategory = "coq" GROUP BY product_name ASC limit '.$limite.','.$nombre;
...
?>
    ...
    <center><h2><em><u><font color = 'red' >Catégorie le Coq Sportif </font></h2>
