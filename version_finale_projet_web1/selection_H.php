...
$sql = mysql_query("SELECT count(DISTINCT product_name) FROM products  WHERE category=	'Homme'  ");
...
$sql ='SELECT * FROM products WHERE category = "Homme" GROUP BY product_name ASC limit '.$limite.','.$nombre;
...
?>
    ...
    <center><h2><em><u><font color = 'red' >Homme</font></h2>
	 <p> Tailles : du 36 au 46 </p>
