...
$sql = mysql_query("SELECT count(DISTINCT product_name) FROM products ");
...
$sql ='SELECT * FROM products GROUP BY product_name ASC limit '.$limite.','.$nombre;
...
?>
    ...
    <center><h2><em><u><font color = 'red' >Catalogue</font></h2>
