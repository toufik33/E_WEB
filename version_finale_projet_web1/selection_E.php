...
$dynamicList = "";
$sql = mysql_query("SELECT count(DISTINCT product_name) from products  WHERE category=	'enfant'  ");
//$sql = mysql_query("SELECT * FROM products  WHERE category=	'enfant' GROUP BY product_name ");
//echo count
...
$sql ='SELECT * FROM products WHERE category = "enfant" GROUP BY product_name ASC limit '.$limite.','.$nombre;
...
?>
    ...
    <center><h2><em><u><font color = 'red' >Enfants</font></h2>
	     <p> Tailles : du 28 au 34 </p>
