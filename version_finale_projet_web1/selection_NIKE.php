...
$sql = mysql_query("SELECT count(DISTINCT product_name) FROM products  WHERE subcategory =	'nike'  ");
...
$sql ='SELECT * FROM products WHERE subcategory = "nike" GROUP BY product_name ASC limit '.$limite.','.$nombre;
...
?>
    ...
    <center><h2><em><u><font color = 'red' >Nike</font></h2>
