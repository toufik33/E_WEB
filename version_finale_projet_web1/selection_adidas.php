...
$sql = mysql_query("SELECT count(DISTINCT product_name) FROM products  WHERE subcategory =	'adidas'");
...
$sql ='SELECT * FROM products WHERE subcategory = "adidas" GROUP BY product_name ASC limit '.$limite.','.$nombre;
...
?>
    ...
    <center><h2><em><u><font color = 'red' >Catégorie adidas  </font></h2>
