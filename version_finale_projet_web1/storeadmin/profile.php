...
if(isset($_GET['id']))
{
        ...
        $dn = mysql_query('select username, email,adresse, avatar, signup_date from users where id="'.$id.'"');
...
?></td>
		...
		Adresse: <?php echo htmlentities($dnn['adresse'], ENT_QUOTES, 'UTF-8'); ?><br />
         Cet utilisateur s'est inscrit le <?php echo htmlentities($dnn['signup_date']); ?></td>
    </tr>
</table>
<?php
        }
